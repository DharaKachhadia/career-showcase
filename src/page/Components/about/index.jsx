    ...
    >
      ...
      <div className="content w-full flex md:mt-5 flex-col md:flex-row">
        <div className="md:w-2/4 w-full p-5 about-content">
          <h1
            className={`font-semibold text-lg mt-5 text-center md:text-star ${DarkMode && "text-white"
              }`}
          >
            DHARA KACHHADIYA
          </h1>
          <p
            className={`text-[#999] mt-5 md:text-start md:text-center	md:tracking-[.5px] ${DarkMode && "text-[#ccc]"
              }`}
          >
            I am a skilled software developer with 2 years of experience in app and web development. My expertise lies in React Native, React, and Next.js, and I am proficient in JavaScript, TypeScript, HTML, and CSS. I have a strong command over front-end technologies like React, Next.js, and Bootstrap, allowing me to create modern and user-friendly interfaces with a focus on UI/UX design.
          </p>
          <p
            className={`text-[#999] mt-3 md:tracking-[.5px] ${DarkMode && "text-[#ccc]"
              }`}
          >
            Additionally, I have hands-on experience with server-side technologies such as Node.js, Firebase, and MongoDB, enabling me to develop full-stack applications.
          </p>
        </div>
