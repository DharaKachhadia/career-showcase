...
import Hostinger from "../../../assets/svg-images/hostinger.svg";
  ...
  return (
    <div className="md:w-2/4 w-full">
      ...
      <div className="flex gap-6 items-center justify-center my-5">
        <div className="tech-card angular" title="Hostinger">
    ...
    <div className="md:w-2/4 flex w-full md:justify-start justify-center mt-16 md:mt-0">
      <div className="relative">
        <div className={`flex first-line ${first && "active"}`}>
          <p
            className={`text-[#323bac] font-semibold tracking-[2px] ${DarkMode && "text-[#525BCC]"
              }`}
          >
            2023
          </p>
          <div className="ml-10">
            <h3
              className={`text-[18px] font-semibold ${DarkMode && "text-[#fff]"
                }`}
            >
              Frontend Developer
            </h3>
