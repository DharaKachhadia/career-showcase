    ...
    >
      ...
      <div className="w-full flex mt-10 flex-col content items-center relative">
        <div className={`bg-white rounded-[14px] py-[22px] pl-[20px] pr-[50px] card md:w-[350px] ${DarkMode && "dark"}`}>
          <div className="flex  items-center">
            ...
            <span className="text-[#323bac] text-[13px] font-semibold pl-1">(2017 - 2019)</span>
          </div>
          <p className="text-[12px] text-[#B7B6B6] tracking-[2px] mt-2">-Higher Secondary Education Ashadeep Group of Schools</p>
          <div className="flex items-center mt-1">
            <span className="text-[#909090] text-[13px]">percentage</span>
            <span className="text-[#909090] text-[13px] pl-1">- (87.14%)</span>
          </div>
        </div>
      </div>
      <div className="w-full flex mt-12 flex-col content items-center relative">
        <div className={`bg-white rounded-[14px] py-[22px] pl-[20px] pr-[50px] card md:w-[350px] ${DarkMode && "dark"}`}>
          ...
          <div className="flex items-center mt-1">
            <span className="text-[#909090] text-[13px] pl-1">[CGPA:- 8.37] [SGPA:- 8.56] </span>
          </div>
        </div>
      </div>
      <div className="w-full flex mt-12 flex-col content items-center">
        <div className={`bg-white rounded-[14px] py-[22px] pl-[20px] pr-[50px] shadow-2xl card md:w-[350px] ${DarkMode && "dark"}`}>
          ...
          <p className="text-[12px] text-[#B7B6B6] tracking-[2px] mt-2">-Jain University (Banglore) - online</p>
          <div className="flex items-center mt-1">
